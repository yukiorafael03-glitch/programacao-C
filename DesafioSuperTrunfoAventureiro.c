...
int main() {
    ...
    densidadePopulacional1 = populacao1 / area1; // Calculando densidade populacional
    pibPerCapita1 = pib1 / populacao1; // Convertendo PIB para reais antes de calcular o PIB per capita
    ...
    densidadePopulacional2 = populacao2 / area2; // Calculando densidade populacional
    pibPerCapita2 = pib2  / populacao2; // Convertendo PIB para reais antes de calcular o PIB per capita
